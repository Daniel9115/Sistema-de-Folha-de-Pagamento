...
- **Validação de entradas** (nome não vazio, valores numéricos positivos)
...
```
Sistema-de-Folha-de-Pagamento/
├── Main.java                      # Ponto de entrada, menu interativo e validações
...
- **Vendas, comissão, qtde de peças e valor por peça**: devem ser números positivos
- Entradas inválidas exibem mensagem de erro e solicitam nova digitação
...
- **Scanner** — leitura e validação de dados via terminal
